...
startUrl = 'https://api.checko.ru/v2/finances?key=' + API_KEY + '&inn='
endUrl = '&extended=true'                         # тут используйте адрес вашего сайта
ALLDATA = '/home/meadowse/finances/'            # эти параметры также индивидуальны для страницы, которую вы скрапите
...
# downloader.save(INN + ".html")         # метод сохраняет полученную строку в файл, путь к которому подается в аргументе